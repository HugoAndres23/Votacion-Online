...
urlpatterns = [
    ...
    # * Position
    path('position/view', views.view_candidatura_by_id, name="viewPosition"),
    ...
    path('positions/view', views.viewcandidaturas, name='viewPositions'),
    ...
    path("settings/ballot/position/update/<int:candidatura>/<str:up_or_down>/",
